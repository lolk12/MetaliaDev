...
<?php $this->beginBody() ?>
                ...
                <div class="mbr-table">
                    <div class="mbr-table-cell">
                        ...
                        <div class="navbar-brand">
                            <a href="<?= Url::toRoute('') ?>" class="navbar-logo"><img src="<?= Url::toRoute('themes/slate/assets/images/022-170x128.jpg') ?>">
                            <a class="navbar-caption" href="<?= Url::toRoute('assets/images/jumbotron.jpg') ?>">Metal Trade</a>
                        </div>
    ...
    <style type="text/css">
        ...
        #header1-4{
            background-image: url("<?= Url::toRoute('themes/slate/assets/images/jumbotron.jpg') ?>")!important;
